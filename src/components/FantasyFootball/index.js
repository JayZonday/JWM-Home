    ...
    return (
      <div>
        ...
        <div className='ff-rankings-section'>
          ...
          <div className='ff-week-desc' id='greenbg'>Week 3 (September 19th - 23th)</div>
        ...
        <img className='bg-football-img' src='https://i.ibb.co/r5K21VR/hiclipart-com-id-degki.png'/>
          ...
          <div className='ff-week-desc'>Week 3 (September 19th - 23th)</div>
        ...
        <div className='ff-daily-section'>
          ...
          <div className='ff-week-desc'>Fanduel Week 3 (September 22th) </div>
